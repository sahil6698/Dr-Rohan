        ...
        <div class="row">
            <div class="col-sm-9">
                ...
                <div class="detail-sec" style="padding-left: 5%; padding-right: 5%;">
                    ...
                    <!--======= Images =========-->
                    <div class="img-single"> <img class="img-responsive" src="../images/blog/1/blog1_1.jpg" alt="" ></div>

                    <!--======= Deneral Information =========-->
                    <div class="detail-sec">
                        <h4>Importance of Breast Cancer Support Groups</h4>
                        ...
                        for ($index=2;$index<=$fileCount;$index++){
                            ...
                            <li class="col-sm-12 item cardiology ophthalmology" style="margin: 5px;">
                                <section> <img class="img-responsive" src="../images/blog/1/blog1_<?php echo $index;?>.jpg" alt="">
                                    <div class="item-over"> <a href="../images/blog/1/blog1_<?php echo $index;?>.jpg" class="item-in pa-20">
                                        </a> </div>
                                </section>
                            </li>
                            <?php
